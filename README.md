...
| 수행 내용 | 주행 데이터 수집·모델 학습·주행 및 정지 동작 적용·표시 작업 수정 |
...
기말 보고서의 주행 코드를 복원해 정리했습니다. 학습 코드와 가중치는 포함하지 않았습니다.
...
관찰한 변화는 기말 보고서에 정리했지만, 처리 시간이나 정지 거리의 전후 측정값은 남기지 않았습니다.
**표시 대상을 줄인 뒤 정지 반응이 개선된 점을 확인했으며**, 표시 작업이 지연의 유일한 원인이었다고 단정할 수는 없습니다.
...
**2024년 기말 보고서에 수록한 주행 코드를 복원해 정리했습니다.**
